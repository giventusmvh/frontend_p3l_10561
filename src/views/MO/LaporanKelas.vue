<template>
  ...
  <div class="container d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Laporan KELAS Bulanan</h1>
  </div>
...
export default {
  setup() {
    ...
    onMounted(() => {
      ...
      axios
        .get("https://api.gofit.given.website/api/laporanKelas")
        .then((response) => {
    ...
    function generatePdf() {
      ...
      const reportTitle = "LAPORAN KELAS BULANAN";
      ...
      html2canvas(table).then((canvas) => {
        ...
        // Save the PDF
        doc.save("laporan_kelas_bulanan.pdf");
      });
    }
    function logout() {
