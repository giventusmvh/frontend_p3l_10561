<template>
  ...
  <div class="container d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">LIST PERIZINAN BELUM KONFIRMASI</h1>
  </div>
      ...
      <div class="col-md-12">
        <div class="card border-0 rounded shadow">
          <div class="card-body">
            ...
            <router-link :to="{ name: 'perizinan' }" class="btn btn-md btn-success shadow">TAMPIL SEMUA</router-link>
              ...
              <tbody class="text-center">
                <tr v-for="(izin, id) in izins" :key="id">
                  ...
                  <td class="text-center">
                    <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal" @click="getId(izin.id)">KONFIRMASI</button>
                  </td>
                </tr>
              </tbody>
            </table>
  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">Yakin konfirmasi data izin ?</div>
